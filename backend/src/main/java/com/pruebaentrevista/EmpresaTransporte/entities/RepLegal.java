...
public class RepLegal implements Serializable {
    ...
    public RepLegal(Long id, String tipoDocumento, BigInteger noDocumento, String nombres, String direccion, String telefono, String ciudad, String depto, String pais) {
        this.id = id;
