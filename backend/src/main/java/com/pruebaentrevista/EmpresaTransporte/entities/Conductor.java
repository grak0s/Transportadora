...
public class Conductor {
    ...
    public Conductor(Integer id, String tipoDocumento, Integer noDocumento, String nombres, String direccion, String telefono, String ciudad, String depto, String pais) {
        this.id = id;
