...
public class Empresa {
    ...
    public Empresa(Integer id, String tipoNit, Integer noNit, String nombres, String direccion, String telefono, String ciudad, String depto, String pais, RepLegal repLegal) {
        this.id = id;
