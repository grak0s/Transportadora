...
public class Vehiculo {
    ...
    public Vehiculo(Integer id, String placa, String motor, String chasis, String modelo, String fechaMatricula, Integer pasSent, Integer pasDep, Integer pesoSeco, Integer pesoBruto, Integer cantPuerta, String marca, String linea) {
        this.id = id;
        this.placa = placa;
        this.motor = motor;
        this.chasis = chasis;
